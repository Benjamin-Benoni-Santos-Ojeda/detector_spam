...
import detector_spam  # Importar nuestro módulo
...
def analizar_email():
  ...
  resultado = detector_spam.predecir_spam(texto, modelo, vectorizer)
...
def main():
  ...
  modelo, vectorizer = detector_spam.entrenar_modelo()
  
  # Mostrar precisión
  accuracy = detector_spam.evaluar_modelo(modelo, vectorizer)
